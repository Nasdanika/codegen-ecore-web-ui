...
/**
 * This is the item provider adapter for a {@link org.nasdanika.codegen.ecore.web.ui.model.EModelElementConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EModelElementConfigurationItemProvider 
	 ...
	 * @generated
	 */
	public EModelElementConfigurationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EModelElementConfiguration_icon_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EModelElementConfiguration_icon_feature", "_UI_EModelElementConfiguration_type"),
				 ModelPackage.Literals.EMODEL_ELEMENT_CONFIGURATION__ICON,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((EModelElementConfiguration)object).getIcon();
		return label == null || label.length() == 0 ?
			getString("_UI_EModelElementConfiguration_type") :
			getString("_UI_EModelElementConfiguration_type") + " " + label;
	}
