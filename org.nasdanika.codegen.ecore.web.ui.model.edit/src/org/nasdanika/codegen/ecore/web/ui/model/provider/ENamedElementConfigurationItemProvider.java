...
/**
 * This is the item provider adapter for a {@link org.nasdanika.codegen.ecore.web.ui.model.ENamedElementConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ENamedElementConfigurationItemProvider extends EModelElementConfigurationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ENamedElementConfigurationItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ENamedElementConfiguration)object).getIcon();
		return label == null || label.length() == 0 ?
			getString("_UI_ENamedElementConfiguration_type") :
			getString("_UI_ENamedElementConfiguration_type") + " " + label;
	}
